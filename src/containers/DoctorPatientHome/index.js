...
class Home extends React.Component {
  constructor(props) {
    super(props);
    this.state = {patient: {}};axios.get('/api/doctor/patient?id='+window.location.pathname.split('/')[1].substr(2), {headers: {authorization: `JWT ${this.props.user.token}`}}).then(result => {
