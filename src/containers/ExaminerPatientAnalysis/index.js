      ...
      <Layout>
        <div style={{width: 900, margin: '0 auto'}}>
          ...
          <Flex justifyContent={'center'} mt={4} mb={3}>
            <Box>
              <Percent value={this.props.examination.analysis ? this.props.examination.analysis.output : null}
                       mx={3}/>
            </Box>
          </Flex>
          <Flex>
          ...
          <Flex>
            <Box width={1 / 2}>
              <ItemAdvice kind={4} text={this.props.examination.analysis_care_w}/>
            </Box>
            <Box width={1 / 2}>
              <ItemAdvice kind={4} text={this.props.examination.analysis_care_h}/>
            </Box>
          </Flex>
        </div>
      </Layout>
