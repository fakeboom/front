          ...
          <Box>
            ...
            <Flex width={900} mt={4}>
              <Box width={1 / 2}
                ...
                <ItemAdvice editable={true} kind={1} sex={0} text={this.props.examination.general_care_w}/>
              </Box>
              <Box width={1 / 2}
                ...
                <ItemNorm name={'其他'} value={this.props.examination.other_h}/>
                            {/* <ItemDate date={'2019-04-16'}/>*/}
                <ItemAdvice editable={true} kind={1} sex={1} text={this.props.examination.general_care_h}/>
              </Box>
            </Flex>
          </Box>
        </Flex>
