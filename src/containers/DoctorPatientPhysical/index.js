          ...
          <Box>
            ...
            <Flex width={900} mt={4}>
              <Box width={1 / 2}
                ...
                <ItemAdvice editable={true} kind={2} sex={0} text={this.props.examination.physical_care_w}/>
              </Box>
              <Box width={1 / 2}
                ...
                <ItemSmall name={'精索静脉曲张程度'} value={this.props.examination.varicocele_degree_h}/>
                            {/* <ItemDate date={'2019-04-16'}/>*/}
                <ItemAdvice editable={true} kind={2} sex={1} text={this.props.examination.physical_care_h}/>
              </Box>
            </Flex>
          </Box>
        </Flex>
...
export default DoctorGetExamination(connect(mapStateToProps)(Radium(Home)));
