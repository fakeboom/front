          ...
          <Box>
            ...
            <Flex width={900} mt={4}>
              <Box width={1 / 2}
                ...
                <ItemAdvice editable={true} kind={3} sex={0} text={this.props.examination.clinical_care_w}/>
              </Box>
              <Box width={1 / 2}
                ...
                <CheckType img={clinicL5R4} title={'血液检测'}>
                  ...
                  <ItemSmall name={'尿常规异常描述'} value={this.props.examination.check_value_niaochangguiyichang_h}/>
                            ...
                            {/* <ItemDate date={'2019-04-16'}/>*/}
                <ItemAdvice editable={true} kind={3} sex={1} text={this.props.examination.clinical_care_h}/>
              </Box>
            </Flex>
          </Box>
        </Flex>
